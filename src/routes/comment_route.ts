 ...
 *             owner:  // Changed to 'owner' and store user _id
 *                type: string
 ...
 *             postId: 67890fghij
 *             owner: 54321zyxwv  // Example user ID
 ...
 * /comments/{id}:
 *    get:
 *       summary: Get a comment by ID (less common)
 *       description: Retrieve a single comment by its ID.  Usually you'd get comments by postId.
 *       tags:
 *          - Comments
 *       parameters:
 *          - in: path
